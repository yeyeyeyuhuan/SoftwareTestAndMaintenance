...
from torchmetrics.classification import MulticlassFBetaScore as FBeta
import tfad
from tfad.ts import TimeSeriesDataset
from tfad.model.distances import CosineDistance
...
from tfad.utils.pl_metrics import CachePredictions
from tfad.utils.donut_metrics import (
...
#         distance: nn.Module = NeuralDistance(),
        ...
        **kwargs,
        ...
        self.encoder1f = tfad.model.TCNEncoder(
            in_channels=self.hparams.ts_channels,
            out_channels=self.hparams.embedding_rep_dim,
            kernel_size=self.hparams.tcn_kernel_size,
            tcn_channels=self.hparams.tcn_out_channels,
        ...
        self.encoder2f = tfad.model.TCNEncoder(
            in_channels=self.hparams.ts_channels,
            out_channels=self.hparams.embedding_rep_dim,
            kernel_size=self.hparams.tcn_kernel_size,
            tcn_channels=self.hparams.tcn_out_channels,
        ...
        # Contrast Classifier
        self.classifier = tfad.model.ContrastiveClasifier(
            distance=distance,
        )
